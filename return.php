...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($delete == 'yes') {
            // if the user said yes to delete, we need to return the product with id = $id
            
            // connect to the database
            $db = connectDB($DBHost, $DBUser, $DBPasswd, $DBName);
            
            
            $query = "UPDATE ORDERS SET STATUS='Returned' WHERE ID=$id AND STOREID='" . $_SESSION['STOREID'] . "';";
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>        
        ...
        <title>return <?php echo $id; ?> ?</title>
    </head>
...
<div class="row">
    <div class="col-xs-12">
        <h1>Do you want to return the order <?php echo $id; ?> </h1>
    </div>
</div>
...
<form action="return.php" method="post">
    <div class="radio">
        <label>
            <input type="radio" name="return" value="yes" checked>
            Yes
        </label>
    </div>
    <div class="radio">
